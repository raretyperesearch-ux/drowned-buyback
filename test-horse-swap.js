...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const hash = crypto.createHash('sha256').update${process.env.SEED_PHRASE}-1).digest();
    ...
    const connection = new Connectionhttps://mainnet.helius-rpc.com/?api-key=${process.env.HELIUS_API_KEY});
